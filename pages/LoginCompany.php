...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white fixed-top d-flex justify-content-cente">
        <div class="container ">
            <!--logo-->
            <a href="../index.php"><img src="../img/lets_job-removebg-preview.png" width="70px" height="70px" alt="Lets Job" /></a>
        </div>
        </div>
        </div>
    </nav> <!--main content-->
    ...
    <div class="container d-flex flex-column flex-lg-row justify-content-evenly mt-5 pt-5" style="padding-top: 10rem;">
        ...
        <div class="text-center text-lg-center mt-lg-5 pt-lg-5">
            <img src="../img/Let_s_job__1_-removebg-preview1.png" width="500px" height="281px" alt="HireSpot" />
            <p class="w-75 mx-auto ma-lg-0 fs-4">
            Lepaskan potensi Anda, Raih hal yang luar biasa!
            </p>
        </div>
          ...
          You have successfully registered! Please Log In
            ...
            <div class="bg-white shadow rounded p-3 input-group-lg">
                <form action="./server/companyLoginProcess.php" method="post">
                    <h1 class="text-center"> Login Perusahaan</h1>
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <div class="">
                                    ...
                                    <span class="text-muted fs-7">Bergabung dengan kami untuk menemukan sesuat</span>
                                </div>
            ...
            <div class="text-center my-5 pb-5">
                <p>
                    Fokus, Motivasi, dan temukan pekerjaan impian anda.
                </p>
            </div>
        </div>
    </div>
    ...
    <footer class="bg-white p-4 text-muted fixed-bottom">
        <div class="container">
            ...
            <div class="d-flex flex-column align-items-center justify-content-cente mt-3">
                ...
                <!--copyrights-->
                <!--div class="d-flex">
                    <a class=" " href="../index.php"><img src="../img/lets_job-removebg-preview.png" width="50px" height="40px"
                            alt="Lets Job" class="mb-2" /></a>
