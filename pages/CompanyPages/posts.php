            ...
            <div class="container">
                ...
                <div class="justify-content-center ">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <!--logo-->
                            <img src="../../img/h.png" width="137px" height="43px" alt="HireSpot" />
                        </li>
                    </ul>
                </div>
                ...
                <div class=" h-100 fixed-top overflow-hidden"
                    ...
                    <div class="d-flex flex-column flex-shrink-0 p-3 d-none d-lg-block vh-100 bg-white "
                        ...
                        <a href="../../index.php"
                            ...
                            <img src="../../img/h.png" height="43px" alt="Lets Job" />
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <select class="form-select" id="inputGroupSelect01" name="jobCategory">
                                                            ...
                                                            <option value="Marketing and Sales">Marketing dan Sales</option>
                                                            <option value="Engineering">Engineering</option>
                                                            <option value="Hospitality and Tourism">Hospitality dan Tourism
                                                            </option>
                                                            <option value="Creative Arts">Creative Arts</option>
                                                            <option value="Human Resources">Sumber Daya Manusia</option>
                                                            <option value="Construction and Trades">Perdagangan Konstruksi
                                                            </option>
                                                        </select>
                                                    </div>
                                                    <div class="form-floating">
                                                        ...
                                                        <label for="floatingTextarea2">Deskripsi tentang lowongan</label>
                                                    </div>
                                                    <div class="mb-1">
