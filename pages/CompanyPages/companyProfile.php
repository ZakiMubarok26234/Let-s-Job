            ...
            <div class="container">
                ...
                <div class="justify-content-center ">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <!--logo-->
                            <img src="../../img/h.png" width="137px" height="43px" alt="Lets Job" />
                        </li>
                    </ul>
                </div>
                ...
                <div class=" h-100 fixed-top overflow-hidden" style="padding-top: 56px;min-width: 10rem;max-width: 12rem;">
                    ...
                    <div class="d-flex flex-column flex-shrink-0 p-3 d-none d-lg-block vh-100 bg-white "
                        ...
                        <a href="../../index.php"
                            ...
                            <img src="../../img/h.png" height="43px" alt="HireSpot" />
...
?>
            ...
            <div class="container  mt-5">
                ...
                <div class="d-flex flex-column align-items-center justify-content-cente mt-3">
                    ...
                    <!--copyrights-->
                    <div class="d-flex">
                        <a class=" " href="../../index.php"><img src="../../img/lets_job-removebg-preview.png" width="58px" height="16px"
